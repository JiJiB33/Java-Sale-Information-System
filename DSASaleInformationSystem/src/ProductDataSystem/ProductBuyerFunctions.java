...
public class ProductBuyerFunctions implements ProductInterface {
    ...
    public ProductBuyerFunctions(Documentation documentation, ProductPurchase productPurchase, List<Product> sharedProducts) {
        this.documentation = documentation;
        this.productPurchase = productPurchase;
        this.products = sharedProducts;  // Use shared products
    }

    public void startBuyerPanel() {
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 3 -> sortProducts(scanner);
                case 4 -> productPurchase.purchaseProduct(scanner, products);
                case 5 -> productPurchase.showOrderHistory();
                case 6 -> {
                    System.out.println("Returning to main menu...");
                    documentation.startSession(); 
                    exit = true;
                }
                case 7 -> {
                    exit = true;
